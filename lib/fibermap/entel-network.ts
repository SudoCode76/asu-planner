...
export const BACKBONE_LINKS: EntelLink[] = [
  ...
  createLink({ id: "or_cb", from: "oruro", to: "cochabamba", km: 210, gbps: 2.5, layer: "backbone", type: "backbone", waypoints: [[-17.9834, -67.1066], [-17.87, -67.03], [-17.65, -66.95], [-17.52, -66.72], [-17.4, -66.45], [-17.39, -66.34], [-17.4, -66.28], [-17.3895, -66.1568]] }),
  createLink({ id: "lp_cb", from: "la_paz", to: "cochabamba", km: 395, gbps: 2.5, layer: "backbone", type: "backbone", waypoints: [[-16.4897, -68.1193], [-16.5, -68.15], [-17.2333, -67.9167], [-17.9834, -67.1066], [-17.87, -67.03], [-17.65, -66.95], [-17.52, -66.72], [-17.4, -66.45], [-17.39, -66.34], [-17.4, -66.28], [-17.3895, -66.1568]] }),
  createLink({ id: "cb_sc", from: "cochabamba", to: "santa_cruz", km: 500, gbps: 2.5, layer: "backbone", type: "backbone", waypoints: [[-17.3895, -66.1568], [-17.389, -66.11], [-17.383, -66.07], [-17.36, -65.98], [-17.317, -65.767], [-17.25, -65.65], [-17.195, -65.56], [-17.08, -65.47], [-16.983, -65.417], [-16.97, -65.15], [-16.99, -64.88], [-17.06, -64.55], [-17.1, -64.2], [-17.28, -63.95], [-17.5, -63.7], [-17.67, -63.42], [-17.786, -63.181]] }),
  createLink({ id: "cb_po", from: "cochabamba", to: "potosi", km: 320, gbps: 1, layer: "backbone", type: "regional", waypoints: [[-17.3895, -66.1568], [-17.401, -66.132], [-17.438, -66.058], [-17.496, -65.963], [-17.55, -65.833], [-17.6, -65.933], [-17.6167, -66.0167], [-18.06, -65.78], [-18.7, -65.2], [-19.0434, -65.2592], [-19.26, -65.43], [-19.5836, -65.7531]] }),
